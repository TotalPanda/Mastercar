#############################################################################
# Makefile for building: mastercar-qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: ven. 3. juil. 16:21:25 2015
# Project:  mastercar-qt.pro
# Template: app
# Command: c:/Qt/4.8.6/bin/qmake.exe USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile mastercar-qt.pro
#############################################################################
...
Makefile: mastercar-qt.pro  ../Qt/4.8.6/mkspecs/default/qmake.conf ../Qt/4.8.6/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile mastercar-qt.pro
...
C:/mastercar-master/src/leveldb/libleveldb.a: FORCE
	cd C:/mastercar-master/src/leveldb && CC=gcc CXX=g++ TARGET_OS=OS_WINDOWS_CROSSCOMPILE $(MAKE) OPT="-pipe -fno-keep-inline-dllexport -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a && ranlib C:/mastercar-master/src/leveldb/libleveldb.a && ranlib C:/mastercar-master/src/leveldb/libmemenv.a
